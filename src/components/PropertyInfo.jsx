      ...
      <div className="bg-[#eff6ff] sm:py-4 ">
        ...
        <div className="flex gap-x-6 px-4 flex-col md:flex-row gap-y-6">
          ...
          <div className=" flex flex-col">
            <div className="bg-white rounded-xl border w-full flex flex-col px-3 py-4 gap-y-3 h-fit">
              ...
              <span className="text-[#6e6e70] font-semibold text-start text-lg">
                Bienes raíces
              </span>
              <div className="bg-[#E7FFE8] px-3 py-2">
                <div className="flex gap-2 items-center">
                  <img src={check} className="w-5 h-5" />
                  <span className="font-bold text-lg text-[#027E07]">
                    Comparte comisión
                  </span>
                </div>
                <span className="text-[#6e6e70] text-start font-semibold">
                  Asesores con registro de asesor que den seguimiento a sus
                  clientes 50/50
                </span>
              </div>

              <div className="border-[#002F6D] border rounded-xl p-2 flex flex-col gap-y-2 text-sm sm:text-md ">
              ...
              <div className="flex gap-5 w-full justify-center ">
                ...
                <button className="bg-[#052682] w-1/2 text-white font-semibold py-2 px-6 sm:px-10 rounded-lg text-sm sm:text-lg mx-2 ">
                  Enviar mensaje
                </button>
              </div>
              ...
              <span className="text-[#ff3d00] text-center font-semibold underline cursor-pointer">
                Reportar anuncio
              </span>
            </div>
        ...
        <div className="relative flex flex-col gap-5 px-6 py-4 ">
          ...
          <div
            ...
            className="max-w-screen  flex gap-12 overflow-x-auto container-carousel scroll-smooth"
          >
            <div
