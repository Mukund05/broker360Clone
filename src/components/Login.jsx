      ...
      <div className="bg-[#eff6ff] p-4 ">
        ...
        <div className="w-[90%] sm:w-4/5 m-auto flex sm:px-0 md:px-16 md:inline-flex flex-col items-center text-center gap-y-4 justify-between">
          ...
          <div className="flex gap-x-2">
            <img src={google} className="w-12 sm:w-16" alt="Google" />
            <img src={twitter} className="w-12 sm:w-16" alt="Twitter" />
            <img src={linkedin} className="w-12 sm:w-16" alt="LinkedIn" />
          </div>
        </div>
      </div>
      <Footer />
