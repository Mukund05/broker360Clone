...
const MessageGateway = () => {
  ...
  const Modal = () => {
    return (
      <div className="fixed bottom-0 right-8 w-4/5 md:w-2/5 h-[65%] md:h-[85%] flex justify-start items-start   z-50 bg-white ">
        <div className="flex flex-col w-full h-full">
          <div className="flex flex-col  w-full h-full">
            ...
            <div className="text-lg sm:text-xl text-[#011b4e]  flex justify-between p-2 px-4 font-semibold">
              Para
            </div>
            <div className="border-y font-semibold border-[#EDEFF1] text-lg sm:text-xl text-[#011b4e]  flex justify-between p-2 px-4">
              Asunto
            </div>
            <div className="text-lg font-semibold sm:text-xl text-[#6e6e70]  flex justify-between p-2 px-4">
              Escribir mensaje
            </div>
          </div>
