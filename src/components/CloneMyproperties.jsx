      ...
      <div className=" py-4">
        <div className="flex gap-3 flex-col">
          ...
          <div className="flex flex-col md:flex-row gap-x-4 my-6 gap-y-8">
            <div className="w-full md:w-1/2 border-xl flex justify-between mx-auto">
            ...
            <div className="md:w-2/3 flex flex-col gap-y-2 gap-x-4 pe-8 px-4">
              <div className="flex flex-wrap gap-y-4 justify-end text-[#6E6E70] gap-x-2 sm:gap-x-4 ">
              ...
              <div className="flex flex-col gap-y-8 md:flex-row gap-x-6 flex-wrap items-center justify-between">
                <PropertyCard
                  heading="svdhasvdhasvhdbahsd"
                  content="ahgdfahsgvdasbhd"
                  route="/view-properties/details"
                />
                <PropertyCard
                  heading="svdhasvdhasvhdbahsd"
                  content="ahgdfahsgvdasbhd"
...
export default CloneMyproperties;
